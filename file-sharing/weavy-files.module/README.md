# Onboarding: Add File Sharing to your HubSpot CMS
...
* Go to your environment on your Weavy account and initiate the **Get Started with Files** wizard
...
<script>
    const files = new Files({ uid: "demofiles" });
    document.getElementById("files-container").append(files);
</script>
{% end_require_js %}
```
* Now create a new web page, and if you've done everything right, you should see a Weavy Files module that you can drag and drop into your page, and file sharing should be rendered
